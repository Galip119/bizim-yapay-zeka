            ...
            try:
                ...
                if basarili:
                    ...
                    try:
                        ...
                        st.warning("MP3 çevrilemedi, orijinal WAV veriliyor.")
                    ...
                    st.download_button(
                        ...
                        file_name="Eymen_Sarki.mp3" if len(ses_dosyasi_mp3) != len(ses_dosyasi_wav) else "Eymen_Sarki.wav",
                        mime="audio/mp3" if len(ses_dosyasi_mp3) != len(ses_dosyasi_wav) else "audio/wav",
